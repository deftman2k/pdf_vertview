...
def make_exe():
    ...
    # policy.resources_location = "in-memory"  #이 설정이 one-file 설정


    # Use filesystem-relative location for adding resources by default.
    policy.resources_location = "filesystem-relative:prefix"
    # policy.resources_location = "filesystem-relative:prefix"  #이 설정이 onedir 설정
    ...
    python_config.run_module = "pdf_vertview"
...
def make_install(exe):
    ...
    files.add_file(FileContent(path = "RELEASE_NOTES.md"), path = "docs/RELEASE_NOTES.md")
